...
import trendli.me.makhana.common.entities.components.DefenseTrait;
...
import trendli.me.makhana.common.entities.components.MoveableTrait;
import trendli.me.makhana.common.entities.components.StaticTrait;
import trendli.me.makhana.common.entities.components.StrengthTrait;
import trendli.me.makhana.common.entities.components.TileTrait;
import trendli.me.makhana.common.entities.components.TypeTrait;
    ...
    private static List< Class< ? >> getAllTraits( )
    {
        try
        {
            return PackageUtils.getAllConcreteClassesFromNames( PackageUtils
                    .getAllClassNamesInPackage( "trendli.me.makhana.common.entities.components" ) );
        }
        catch ( IOException e )
        {
